!(function (r) {
  ...
  function s() {
    ...
    function t() {
      a.removeClass("fadeOutLeft closed"),
        a.show(),
        r("body").addClass("ajax-page-visible");
    }
    var o = r(".ajax-page-load").each(function () {
      if (
        ((o = r(this).attr("href")),
        location.hash ==
          location.hash.split("/")[0] + "/" + o.substr(0, o.length - 5))
      ) {
    ...
    r(document)
      .on("click", "#ajax-page-close-button", function (e) {
        e.preventDefault(),
          r("#page-ajax-loaded").addClass("fadeOutLeft closed"),
          r("body").removeClass("ajax-page-visible"),
          setTimeout(function () {
      ...
      .on("click", ".ajax-page-load", function () {
        var e =
          ...
          r(this)
            .attr("href")
            .substr(0, r(this).attr("href").length - 5);
        return (location.hash = e), t(), !1;
      });
  }
  function d() {
    150 < r(i).scrollTop()
      ? r(".jagratPatel-scroll-to-top").removeClass("hidden-btn")
      : r(".jagratPatel-scroll-to-top").addClass("hidden-btn");
  }
  r(function () {
    r("#contact_form").validator(),
      r("#contact_form").on("submit", function (e) {
          ...
          return (
            r.ajax({
              ...
              success: function (e) {
                ...
                a &&
                  t &&
                  (r("#contact_form").find(".messages").html(o),
                  r("#contact_form")[0].reset());
              },
            }),
            !1
          );
    ...
    r(window)
      .on("load", function () {
        var e, a, t;
        r(".preloader").fadeOut(800, "linear"),
          (e = r(window).width()),
          (a = ""),
          (t = r("#page_container").attr("data-animation")),
          (a = r(991 < e ? ".page-container" : ".site-main")).addClass(
            "animated " + t
          ),
          r(".page-scroll").addClass("add-prespective"),
          a.addClass("transform3d"),
          setTimeout(function () {
            r(".page-scroll").removeClass("add-prespective"),
    ...
    r(document).on("ready", function () {
      ...
      r("body")
        .on("mousemove", function (e) {
          var a = e.pageX - r(document).width() / 2,
            ...
            o = n * a * -1,
            i = l * t * -1;
          if (r(".page-container").hasClass("bg-move-effect"))
            var s = r(
      ...
      a.imagesLoaded(function () {
        ...
        e.imagesLoaded(function () {
          r(".portfolio-content").each(function () {
            ...
            a &&
              (a.shuffle({ speed: 450, itemSelector: "figure" }),
              ...
              t.on("click", ".filter", function (e) {
                a.shuffle("update"),
                  ...
                  a.shuffle("shuffle", r(this).attr("data-group"));
              }));
          });
        }),
      ...
      o.imagesLoaded(function () {
        o.masonry({ itemSelector: ".item", resize: !1 });
      }),
        r(".menu-toggle").on("click", function () {
          r(".site-nav").addClass("animate"),
            r(".site-nav").toggleClass("mobile-menu-hide");
        }),
        ...
        r(".form-control").val(""),
        r(".form-control").on("focusin", function () {
          r(this).parent(".form-group").addClass("form-group-focus");
        }),
        r(".form-control").on("focusout", function () {
          0 === r(this).val().length &&
            r(this).parent(".form-group").removeClass("form-group-focus");
        }),
        r("body").append(
        ...
        s(),
        r(".sidebar-toggle").on("click", function () {
          r("#blog-sidebar").toggleClass("open"), r(this).toggleClass("open");
        }),
        r(".jagratPatel-scroll-to-top").click(function () {
